...
# v.1.4.812 se mofifican y depuran funciones abrir y crear nuevo hanilitando o no "guardar como"
# v.1.4.812 se verifica que no hay errores si no se eligen archivos al crear abrir o guardar como
# v.1.4.812 se verifica que botoles "modificar" y "eliminar" cuenta solo se habilitan si se selecciona una en la lista
# v.1.4.812 se agrega boton cambiar a modo enigma en toolbar archivo
# v.1.4.812 se elimina boton generar clave privada de la toolbar enigma
# v.1.4.812 se elimina propiedad movable y flotable de las toolbar porque pueden quedar mal ubicadas
# v.1.4.812 si una toolbar se abre se cierra la otra, pero se pueden cerrar ambas
# v.1.4.812 se agrega funcion que no permite que ambas toolbars esten activas al mismo tiempo
...
class enigmaVentana(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.title = "Enigma con Pandas v.1.4.812"
    ...
    def CreateMenu(self):
        ...
        #01/03/2023
        self.EnigmaEncrypt = QAction(QIcon('icons/crypt.png'), 'Encryptar Registro', self)
        ...
        self.EnigmaEnigma = QAction(QIcon('icons/pkeyp.png'), 'Cambiar a Modo Enigma', self)
        ...
        self.EnigmaRegistros = QAction(QIcon('icons/editar.png'), 'Cambiar a Modo Registros', self)
        ...
        #para enigma toolbar
        self.mregs = QAction(QIcon("icons/editar.png"),"Cambiar a Modo Registros",self)
        ...
        self.Encrypt = QAction(QIcon('icons/crypt.png'), 'Encryptar Registro', self)
        ...
        self.mEnigma = QAction(QIcon("icons/pkeyp.png"),"Cambiar a Modo Enigma",self)
    ...
    def cambiovisibilidadtbf(self):
        if self.tbf.isVisible() == True:
            self.tbe.setVisible(False)
        #elif self.tbf.isVisible() == False:
        #    self.tbe.setVisible(True)
    
    def cambiovisibilidadtbe(self):
        if self.tbe.isVisible() == True:
            self.tbf.setVisible(False)
        #elif self.tbe.isVisible() == False:
        #    self.tbf.setVisible(True)
    ...
    def modoRegistros(self):
        self.indicadorRegselec.setText(str(self.indiceFilaselec))
        print('recontruye pantalla de modo registros')
        self.AlertadeLLavepnc.hide()
        self.AlertadeLLavepc.hide()
        self.regMode(True)
